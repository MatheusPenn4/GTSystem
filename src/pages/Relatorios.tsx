  ...
  const getRelatoriosDisponiveis = () => {
    if (user?.role === 'transportadora') {
      return [
        ...
        },
        {
          ...
          icon: BarChart3,
          dados: ['Gasto total: R$ 2.340', 'Média mensal: R$ 780', 'Economia: R$ 450']
        }
      ];
    }
    ...
    if (user?.role === 'estacionamento') {
      return [
        ...
        },
        {
          ...
          icon: BarChart3,
          dados: ['Receita mensal: R$ 8.750', 'Crescimento: +12%', 'Ticket médio: R$ 25']
        },
        {
    ...
    return [
      ...
      },
      {
        ...
        icon: BarChart3,
        dados: ['Receita total: R$ 45.670', 'Comissões: R$ 4.567', 'Crescimento: +15%']
      }
    ];
  };
