"""
URL configuration for parkingmgr project.
...
urlpatterns = [
    ...
    # API URLs
    path('api/auth/', include('ajh_auth.urls')),
    path('api/company/', include('ajh_company.urls')),
    path('api/parking/', include('ajh_parking.urls')),
    path('api/plans/', include('ajh_plans.urls')),
